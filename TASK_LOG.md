...
- [x] ~~**目标:** 支持第三方 Tavily MCP/Hikari 配置，并让 Admin/MCP Token 可同步 Hugging Face Secrets 防止重启回退~~ (创建于: 2026-05-17 16:47:43 | **完成于: 2026-05-17 17:06:02**)
...
- [x] ~~**目标:** 通过 Browser Relay 重新写入 Hugging Face Space 临时 Secrets 并验证线上运行~~ (创建于: 2026-05-17 16:03:45 | **完成于: 2026-05-17 16:07:37**)

- [x] ~~**目标:** 补写 Tavily 相关 Hugging Face Secrets 并验证线上状态~~ (创建于: 2026-05-17 16:40:52 | **完成于: 2026-05-17 16:43:15**)
